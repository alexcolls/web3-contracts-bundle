...
const UNLOCK_TIME = 1681383600
const VESTING_SCHEDULE = {
  when: [
    1681383600, //04/13/2023 11:00:00 UTC
    1683975600, //05/13/2023 11:00:00 UTC
    1686654000, //06/13/2023 11:00:00 UTC
  ...
  amount: [
    ethers.utils.parseEther(String(63541666)),
    ethers.utils.parseEther(String(63541666)),
    ethers.utils.parseEther(String(63541666)),
    ethers.utils.parseEther(String(63541666)),
    ethers.utils.parseEther(String(63541666)),
    ...
    ethers.utils.parseEther(String(63541666)),
    ethers.utils.parseEther(String(63541666)),
    ethers.utils.parseEther(String(63541674)),
  ]
}
...
async function main() {
  ...
  console.log(
    `VestingBasic "Liquidity" allocation deployed to ${vestingBasic.address}`
  )
}
