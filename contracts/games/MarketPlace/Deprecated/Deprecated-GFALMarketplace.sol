...
//         require(
//             IERC20(gfalToken).allowance(msg.sender, address(this)) >= price,
...
//         IERC20(gfalToken).safeTransferFrom(
//             msg.sender,
//             seller,
...
//                     ? OracleConsumer(oracleConsumer).getConversionRate(
//                         currentSale.price
//                     ) // if isDollar we convert it to GFAL
//                     : currentSale.price;
//                 counter++;
//             }
//         }
