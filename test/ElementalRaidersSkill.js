...
describe("ElementalRaidersSkill", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should have been set tokenURI", async function () {
      ...
      const expectedTokenURI = "https://dev-validator-kypdm5df6a-uc.a.run.app/api/web3/tracker/"+elementalRaidersSkill.address+"/"
  ...
  describe("Workflow", function () {
    ...
    describe("Transfers", function () {
      it("Should let the owner mint a token for an user", async function () {
        ...
        await expect(tokenURI).to.equal('https://dev-validator-kypdm5df6a-uc.a.run.app/api/web3/tracker/0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0/0')
