const {
  ...
  describe("ElementalRaidersSkin", function () {
    ...
    async function deployContracts() {
      ...
      const elementalRaidersSkin = await ElementalRaidersSkin.deploy(gfalToken.address, oracleConsumer.address, "ipfs://");
  
      await elementalRaidersSkin.updateBaseURI(NFT_METADATA_BASEURI + elementalRaidersSkin.address + "/")
      await elementalRaidersSkin.updateMintingPrice(1, hre.ethers.utils.parseEther('50'))
      await elementalRaidersSkin.updateMintingPrice(2, hre.ethers.utils.parseEther('100'))
      await elementalRaidersSkin.updateMintingPrice(3, hre.ethers.utils.parseEther('150'))
      await elementalRaidersSkin.updateMintingPrice(4, hre.ethers.utils.parseEther('200'))
